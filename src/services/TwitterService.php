...
class TwitterService extends Component
{
    ...
    public function __construct(array $settings = [])
    {
        ...
        {
            throw new RuntimeException('Twitter Plugin requires cURL extension to be loaded, see: http://curl.haxx.se/docs/install.html');
        }

        $this->instance = TwitterFeedPlugin::getInstance();
        
        $settings = [
            'oauth_access_token' => $this->instance->getSettings()->oauthAccessToken,
            'oauth_access_token_secret' => $this->instance->getSettings()->oauthAccessTokenSecret,
            'consumer_key' => $this->instance->getSettings()->consumerKey,
            'consumer_secret' => $this->instance->getSettings()->consumerSecret
        ];
